            ...
            getPost((snap) => {
                snap.forEach(element => {
                    ...
                    if (user.uid === element.val().uid) {
                        myPosts(element.key, element.body, element.mode);
                    } else {
